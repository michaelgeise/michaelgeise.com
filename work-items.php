<!-- EMR Patient Portal Web App -->
                        ...
                        <!-- Design System for Geospatial Website -->
                        <div class="work-item d-flex justify-content-start" data-toggle="modal" data-target="#design-system-modal">
                            <div class="work-item-img-wrapper">
                                <img class="img-fluid work-item-img rounded" src="images/work/design-system-for-geospatial-website.jpg" alt="Components in Figma" />
                            </div>
                            <div class="">
                        ...
                        <!-- Medical Dictation Mobile App -->

                        <div class="work-item d-flex justify-content-start" data-toggle="modal" data-target="#medical-dictation-modal">
                            <div class="work-item-img-wrapper">
                                <img class="img-fluid work-item-img rounded" src="images/work/medical-dictation-mobile-app.jpg" alt="three mobile app screens" />
                            </div>
                            <div class="">
                        ...
                        <div class="work-item d-flex justify-content-start" data-toggle="modal" data-target="#park-modal">
                            <div class="work-item-img-wrapper">
                                <img class="img-fluid work-item-img rounded" src="images/work/park-mobile-app.jpg" alt="screen from the prototype in a iPhone" />
                            </div>
                            <div class="">
                        ...
                        <!-- Large Insurance Company E-Commerce Web App -->

                        <div class="work-item d-flex justify-content-start" data-toggle="modal" data-target="#insurance-web-app-modal">
                            <div class="work-item-img-wrapper">
                                <img class="img-fluid work-item-img rounded" src="images/work/large-insurance-company-e-commerce-web-app.jpg" alt="wireframe and mockup" />
                            </div>
                            <div class="">
                        ...
                        <!-- Hardware-as-a-Service Startup Web App -->
                        <div class="work-item d-flex justify-content-start" data-toggle="modal" data-target="#haas-modal">
                            <div class="work-item-img-wrapper">
                                <img class="img-fluid work-item-img rounded" src="images/work/hardware-as-a-service-web-app.jpg" alt="two wireframes" />
                            </div>
                            <div class="">
                        ...
                        <!-- Tech Non-Profit User Research -->

                        <div class="work-item d-flex justify-content-start" data-toggle="modal" data-target="#tech-non-profit-user-research-modal">
                            <div class="work-item-img-wrapper">
                                <img class="img-fluid work-item-img rounded" src="images/work/tech-non-profit-user-research.jpg" alt="affinity map from research" />
                            </div>
                            <div class="">
                        ...
                        <!-- Exercise Booking App -->
                        <div class="work-item d-flex justify-content-start" data-toggle="modal" data-target="#exercise-booking-app-modal">
                            <div class="work-item-img-wrapper">
                                <img class="img-fluid work-item-img rounded" src="images/work/exercise-booking-app.jpg" alt="app in an iPhone" />
                            </div>
                            <div class="">
